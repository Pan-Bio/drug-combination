...
write.table(file='5-sd_proteinnet.txt',sd_proteinnet,append=F,row.names = FALSE,col.names = FALSE,quote = FALSE)
write.table(file='5-sd_proteinname.txt',target,append=F,row.names = FALSE,col.names = FALSE,quote = FALSE)
################st_proteinnet#########################
...
write.table(file='1-st_proteinnet.txt',st_proteinnet,row.names = FALSE,col.names = FALSE,quote = FALSE)
write.table(file='1-st_proteinname.txt',protein,row.names = FALSE,col.names = FALSE,quote = FALSE)
############sd_proteinfeature###############


index=apply(target,1,function(x){which(feature[,1]==x)[1]})
sd_proteinfeature=feature[index,2:27]
write.table(file='5-sd_proteinfeature.txt',sd_proteinfeature,append=F,row.names = FALSE,col.names = FALSE,quote = FALSE)
#############st_proteinfeature###############

index=apply(protein,1,function(x){which(feature[,1]==x)[1]})
st_proteinfeature=feature[index,2:27]
write.table(file='1-st_proteinfeature.txt',st_proteinfeature,row.names = FALSE,col.names = FALSE,quote = FALSE)
...
write.table(file='1-st_label.txt',st_label,row.names = FALSE,col.names = FALSE,quote = FALSE)